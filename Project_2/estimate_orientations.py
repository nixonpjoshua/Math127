...
def compute_line_angles(line1,line2,line3):
	"""
	Computes common angles between the the three different lines
	generated by compute_common_lines
	"""
	return

def compute_plane_angles(ang1,ang2,ang3):
	"""
	Computes common angles between the the three different planes
	generated by compute_line_angels
	"""
	return
